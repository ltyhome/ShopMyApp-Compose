...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PickerLibraryAccessors laccForPickerLibraryAccessors = new PickerLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at picker
     */
    public PickerLibraryAccessors getPicker() { return laccForPickerLibraryAccessors; }
    ...
    public static class ArrowLibraryAccessors extends SubDependencyFactory {
        ...
        public ArrowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for bom (io.arrow-kt:arrow-stack)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getBom() { return create("arrow.bom"); }
    ...
    public static class ComposeUiLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public ComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getPreview() { return create("compose.ui.preview"); }
    ...
    public static class GlideLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public GlideLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for okhttp (com.github.bumptech.glide:okhttp3-integration)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getOkhttp() { return create("glide.okhttp"); }
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        public KtorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getNegotiation() { return create("ktor.negotiation"); }
            ...
            /**
             * Creates a dependency provider for serialization (io.ktor:ktor-serialization-gson)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getSerialization() { return create("ktor.serialization"); }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public OkhttpLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUrlconnection() { return create("okhttp.urlconnection"); }

    }

    public static class PickerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public PickerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for picker (io.github.lucksiege:pictureselector)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("picker"); }

            /**
             * Creates a dependency provider for camerax (io.github.lucksiege:camerax)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCamerax() { return create("picker.camerax"); }

            /**
             * Creates a dependency provider for compress (io.github.lucksiege:compress)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompress() { return create("picker.compress"); }

            /**
             * Creates a dependency provider for ucrop (io.github.lucksiege:ucrop)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUcrop() { return create("picker.ucrop"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: agp (8.2.0-alpha04)
            ...
            /**
             * Returns the version associated to this alias: androidxHilt (1.1.0-alpha01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: firebase (2.9.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: picker (v3.11.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getPicker() { return getVersion("picker"); }
            ...
            /**
             * Returns the version associated to this alias: update (0.8.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUpdate() { return getVersion("update"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for navigation to the plugin id 'androidx.navigation.safeargs.kotlin'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getNavigation() { return createPlugin("navigation"); }

            /**
             * Creates a plugin provider for update to the plugin id 'nl.littlerobots.version-catalog-update'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getUpdate() { return createPlugin("update"); }
